              ...
              >
                  ...
                  {/* <li className=" nav-item">
                      ...
                      <ul className="menu-content">
                              ...
                              <ul className="menu-content">
                                  <li>
                                      <a
                                          ...
                                          href="page-auth-login-v1.html"
                                          target="_blank"
                                      >
                                          <span className="menu-item text-truncate" data-i18n="LoginV1">
                                              Login v1
                                          </span>
                                      </a>
                                  </li>
                                  <li>
                                      <a
                                          ...
                                          target="_blank"
                                      >
                                          <span className="menu-item text-truncate" data-i18n="LoginV2">
                                              Login v2
                                          </span>
                                      </a>
                                  </li>
                                  <li>
                                      <a
                                          className="d-flex align-items-center"
                                          href="page-auth-register-v1.html"
                                          target="_blank"
                                      >
                                          <span
                                              className="menu-item text-truncate"
                                              data-i18n="RegisterV1"
                                          >
                                              Register v1
                                          </span>
                                      </a>
                                  ...
                                  <li>
                                      <a
                                          className="d-flex align-items-center"
                                          href="page-auth-register-v2.html"
                                          target="_blank"
                                      >
                                          <span
                                              className="menu-item text-truncate"
                                              data-i18n="RegisterV2"
                                          >
                                              Register v2
                                          </span>
                                      </a>
                                  ...
                                  <li>
                                      <a
                                          className="d-flex align-items-center"
                                          href="page-auth-forgot-password-v1.html"
                                          target="_blank"
                                      >
                                          <span
                                              className="menu-item text-truncate"
                                              data-i18n="ForgotPasswordV1"
                                          >
                                              Forgot Password v1
                                          </span>
                                      </a>
                                  ...
                                  <li>
                                      <a
                                          className="d-flex align-items-center"
                                          href="page-auth-forgot-password-v2.html"
                                          target="_blank"
                                      >
                                          <span
                                              className="menu-item text-truncate"
                                              data-i18n="ForgotPasswordV2"
                                          >
                                              Forgot Password v2
                                          </span>
                                      </a>
                                  ...
                                  <li>
                                      <a
                                          className="d-flex align-items-center"
                                          href="page-auth-reset-password-v1.html"
                                          target="_blank"
                                      >
                                          <span
                                              className="menu-item text-truncate"
                                              data-i18n="ResetPasswordV1"
                                          >
                                              Reset Password v1
                                          </span>
                                      </a>
                                  ...
                                  <li>
                                      <a
                                          className="d-flex align-items-center"
                                          href="page-auth-reset-password-v2.html"
                                          target="_blank"
                                      >
                                          <span
                                              className="menu-item text-truncate"
                                              data-i18n="ResetPasswordV2"
                                          >
                                              Reset Password v2
                                          </span>
                                      </a>
                          ...
                          <li>
                              <a className="d-flex align-items-center" href="page-profile.html">
                                  <i data-feather="circle" />
                          ...
                          <li>
                              <a className="d-flex align-items-center" href="page-pricing.html">
                                  <i data-feather="circle" />
                  ...
                  <li className=" nav-item">
                      <a className="d-flex align-items-center" href="ui-typography.html">
                          <i data-feather="type" />
                  ...
                  <li className=" nav-item">
                      <a className="d-flex align-items-center" href="ui-feather.html">
                          <i data-feather="eye" />
                  ...
                  <li className=" nav-item">
                      ...
                      <ul className="menu-content">
                          <li>
                              <a className="d-flex align-items-center" href="card-basic.html">
                                  <i data-feather="circle" />
                          ...
                          <li>
                              <a className="d-flex align-items-center" href="card-advance.html">
                                  <i data-feather="circle" />
                          ...
                          <li>
                              <a className="d-flex align-items-center" href="card-analytics.html">
                                  <i data-feather="circle" />
                          ...
                          <li>
                              <a className="d-flex align-items-center" href="card-actions.html">
                                  <i data-feather="circle" />
                                  <span
                                      className="menu-item text-truncate"
                  ...
                  <li className=" nav-item">
                      ...
                      <ul className="menu-content">
                          ...
                          <li>
                              <a className="d-flex align-items-center" href="layout-full.html">
                                  <i data-feather="circle" />
                          ...
                          <li>
                              <a className="d-flex align-items-center" href="layout-empty.html">
                                  <i data-feather="circle" />
                                  <span
                                      className="menu-item text-truncate"
                          ...
                          <li>
                              <a className="d-flex align-items-center" href="layout-blank.html">
                                  <i data-feather="circle" />
                                  <span
                                      className="menu-item text-truncate"
                  ...
                  <li className=" nav-item">
                      ...
                      <ul className="menu-content">
                          <li>
                              <a className="d-flex align-items-center" href="form-input.html">
                                  <i data-feather="circle" />
                          ...
                          <li>
                              <a className="d-flex align-items-center" href="form-textarea.html">
                                  <i data-feather="circle" />
                          ...
                          <li>
                              <a className="d-flex align-items-center" href="form-checkbox.html">
                                  <i data-feather="circle" />
                          ...
                          <li>
                              <a className="d-flex align-items-center" href="form-radio.html">
                                  <i data-feather="circle" />
                          ...
                          <li>
                              <a className="d-flex align-items-center" href="form-switch.html">
                                  <i data-feather="circle" />
                          ...
                          <li>
                              <a className="d-flex align-items-center" href="form-select.html">
                                  <i data-feather="circle" />
                  ...
                  <li className=" nav-item">
                      <a className="d-flex align-items-center" href="form-layout.html">
                          <i data-feather="box" />
                  ...
                  <li className=" nav-item">
                      <a className="d-flex align-items-center" href="form-wizard.html">
                  ...
                  <li className=" nav-item">
                      <a className="d-flex align-items-center" href="form-validation.html">
                  ...
                  <li className=" nav-item">
                      <a className="d-flex align-items-center" href="form-repeater.html">
                  ...
                  <li className=" nav-item">
                      <a className="d-flex align-items-center" href="table-bootstrap.html">
                  ...
                  <li className=" nav-item">
                      ...
                      <ul className="menu-content">
                          <li>
                              <a className="d-flex align-items-center" href="chart-apex.html">
                                  <i data-feather="circle" />
                          ...
                          <li>
                              <a className="d-flex align-items-center" href="chart-chartjs.html">
                                  <i data-feather="circle" />
                  ...
                  <li className=" nav-item">
                      <a className="d-flex align-items-center" href="maps-leaflet.html">
                          <i data-feather="map" />
